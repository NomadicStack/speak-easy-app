...
SpeakEasy is an accessible communication app designed for people with dysarthria. It uses on-device AI to transcribe speech and expand short phrases into full, natural sentences.

---

## 1. Getting Started

### Transcription (Basic Voice-to-Text)
- **What it is:** Converts your spoken words into text on the screen.
- **How to use:** 
...
- **AI Brain (Models):** View and download the Gemma 4 model (2.6GB). Required for Smart Speak.
- **Simulate AI:** Found under **"Advanced"**. Enabling this allows you to test Smart Speak without downloading the 2.6GB model (useful for testing on simulators).
- **Clear Cache:** Deletes all downloaded models to free up storage space.
